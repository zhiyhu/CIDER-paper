# De Novo CIDER on simulated data
# 9/17/2020
# Zhiyuan Hu
...
for(itor in 1:20){
  ...
  runtime_tmp <- system.time({
    seu_list <- initialClusteringSeurat_faster(seu, dim = 10, resolution = 0.3, 
                                               verbose = verbose, n.cores = n_cores) 
  })
  ...
  for(seu_itor in 1:length(dist_coef)){
    print(mclust::adjustedRandIndex(seu_list[[seu_itor]]$inicluster, seu_list[[seu_itor]]$Group))
  }
  ...
  saveRDS(dist_coef,  paste0("/home/z/zhu/cider/rdata/", dirsave, "/dnCIDER_dist_coef",itor,".rds"))
  saveRDS(results, paste0("/home/z/zhu/cider/rdata/", dirsave, "/dnCIDER_ARI_res",itor,".rds"))
  saveRDS(clustering_res, paste0("/home/z/zhu/cider/rdata/", dirsave, "/dnCIDER_clustering_res",itor,".rds"))
}