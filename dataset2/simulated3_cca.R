...
for(itor in 1:20){
  ...
  saveRDS(results, paste0("/home/z/zhu/cider/rdata/", dirsave, "/CCA_ARI_res",itor,".rds"))
  saveRDS(clustering_res, paste0("/home/z/zhu/cider/rdata/", dirsave, "/CCA_clustering_res",itor,".rds"))
}