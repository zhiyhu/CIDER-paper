...
for(itor in 1:20){
  ...
  runtime <- system.time({
    ...
    lgr <- louvainCluster(lgr, resolution = 0.4)
  })[3]
  ...
  saveRDS(results, paste0("/home/z/zhu/cider/rdata/", dirsave, "/liger_ARI_res",itor,".rds"))
  saveRDS(clustering_res, paste0("/home/z/zhu/cider/rdata/", dirsave, "/liger_clustering_res",itor,".rds"))
}
