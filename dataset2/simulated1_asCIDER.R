# Assisted CIDER on simulated data
# 10 Aug 2021
# Zhiyuan Hu
...
for(itor in 1:20){
  ...
  saveRDS(dist_coef,  paste0("/home/z/zhu/cider/rdata/", dirsave, "/asCIDER_dist_coef",itor,".rds"))
  saveRDS(results, paste0("/home/z/zhu/cider/rdata/", dirsave, "/asCIDER_ARI_res",itor,".rds"))
  saveRDS(clustering_res, paste0("/home/z/zhu/cider/rdata/", dirsave, "/asCIDER_clustering_res",itor,".rds"))
}
