...
for(i in 1:length(methods)){
  if(methods[i] %in% c("asCIDER", "dnCIDER")){
    ari_tmp <- readRDS(paste0("~/Dropbox/CIDER/evaluate-integration/cbrg/rdata/", dirsave, "/", methods[i],"_ARI_res_sr.rds"))
  } else {
